...
if __name__ == "__main__":
    filename_raw = 'C:/Users/Allan Ngo/Desktop/HW1_r08723042_吳豐光/data/eurusd_2010_2017.csv'
    filename_pro = 'C:/Users/Allan Ngo/Desktop/HW1_r08723042_吳豐光/data/eurusd_2010_2017_1T.csv'
    filename_rule = 'C:/Users/Allan Ngo/Desktop/HW1_r08723042_吳豐光/data/eurusd_2010_2017_1T_rulebase.csv'
    pattern_path = 'C:/Users/Allan Ngo/Desktop/HW1_r08723042_吳豐光/pattern'
    timeScale = '1min'
    signal_ls = ['BullishAbandonedBaby','BearishAbandonedBaby','ThreeBlackCrows','ThreeWhiteSoldiers','BearishHarami','BearishEngulfing','BullishHarami','BullishEngulfing']
    ...
    for signal in signal_ls:
        path = 'C:/Users/Allan Ngo/Desktop/HW1_r08723042_吳豐光/pattern/' + str(signal) 
        os.mkdir(path)
        M.graph(signal)
